...
var programInfo: ProgramInfo = ProgramInfo(name: "bootoption", version: "0.2.6", copyright: "Copyright © 2017-2018 vulgo", license: "This is free software: you are free to change and redistribute it.\nThere is NO WARRANTY, to the extent permitted by law.\nSee the GNU GPL version 3 or later <http://gnu.org/licenses/gpl.html>")
...
let createVerb = Verb(withName: "create", helpMessage: "create a new EFI load option")
